...
import { DEFAULT_SQUIRCLE_CURVATURE, ElementCollector, getSquircleClipPathID, QueryDeclarations } from '../../../src'
...
describe('BaseElement', () => {
  ...
  it('generates the correct shape styles', async () => {
    ...
    expect(test.shapeStyleInfo).toStrictEqual({
      clipPath: `url(#${getSquircleClipPathID(test.size, test.shapeSquircleCurvature)})`
    })
  })
